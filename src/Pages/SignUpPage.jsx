...
function SignUpPage() {
  return (
    ...
    >
      ...
      <div
        id="form wrapper"
        className="w-[100%] min-h-[100vh] bg-black bg-opacity-80 flex flex-col justify-center items-center  sm:w-[50%] sm:min-h-[95dvh]  sm:rounded-[40px] sm:px-[59px] sm:py-[15px] "
      >
        {/* Form section */}
        <SignUpForm />
      </div>
