    ...
    <>
      ...
      <main className="px-[4%] min-h-[50vh] my-2 sm:w-[95%] sm:mx-auto">
        <div id="what we offer" className="sm:min-h-[5vh]  ">
          ...
          <p className="sm:text-[21px] sm:font-[400] font-poppins text-justify text-[.8rem] md:text-[21px] md:font-normal md:leading-[35px]  ">
          ...
          <ul className="sm:text-[24px] sm:font-[400] list-inside font-poppins pl-2 pr-3 ">
            <li className="list-disc text-justify text-[.8rem] md:text-[21px] md:font-normal md:leading-[35px]">
