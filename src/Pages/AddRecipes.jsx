...
export default function AddRecipes() {
  ...
  return (
    ...
    >
      ...
      <div
        id="form wrapper"
        className="w-[100%] min-h-[100vh] bg-black bg-opacity-30 backdrop-blur flex flex-col justify-center items-center  sm:w-[50%] sm:min-h-[95vh]  sm:rounded-[40px] sm:px-[59px] sm:py-[15px] "
      >
       <AddRecipeForm />
      </div>
    </div>
