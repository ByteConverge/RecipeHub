  ...
  return (
    <>
      <Body>
        ...
        {/*  */}
        <main className="px-[4%] min-h-[100vh] my-2 md:w-[95%] md:mx-auto ">
          {/* welcome Flavors one */}
          <div
            id="welcomeFlavors"
            className="min-h-[50vh] mb-2  md:flex  md:mb-[10px] md:w-[100%] md:gap-3  md:h-[80vh] md:justify-between "
          >
            {/* texts */}
            <div
              id="heading--text"
            ...
            >
              {/* h1 */}
              <h1 className="text-center text-[#996D3E] font-semibold font-poppins  md:text-[30px] md:mb-[1rem] md:text-left">
                Welcome to the Flavors of Nigeria!
              </h1>
              <p className="text-justify font-poppins text-[.8rem]  md:text-left md:text-[21px] md:font-normal md:leading-[35px] ">
              ...
              <p className="text-justify font-poppins text-[.8rem]  md:text-left md:text-[21px] md:font-normal md:leading-[35px]mb-3  ">
            ...
            >
              <img
                src={flavorDish}
                alt=""
                className="h-[100%] w-[100%] rounded-[1rem] md:rounded-[25px]  md:h-[80%] md:w-[
              70%]  "
              />
            </figure>
          </div>
          ...
          <div
            ...
            className="min-h-[50vh] mb-2 md:flex  md:mb-[3rem] md:w-[100%] md:gap-8 md:flex-row-reverse md:justify-between "
          >
            <div
              id="text"
            ...
            >
              ...
              <p className=" text-justify font-poppins text-[.8rem] mb-3  md:text-left md:text-[21px] md:font-normal md:leading-[35px] ">
