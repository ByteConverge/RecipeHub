          ...
          >
            ...
            <div id="name--field" className="mb-2 sm:mb-2">
              ...
              <input
                ...
                className="text-[13px] px-2 block w-full border-white border-solid bg-black bg-opacity-50 focus:outline-none focus:border-white rounded-xl h-[2.5rem]  border-[0.772px] sm:h-[25px] "
              />
            </div>
            {/* Email */}
