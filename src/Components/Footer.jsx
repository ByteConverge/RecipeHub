...
export default function Footer() {
  return (
    <footer className="bg-black p-6 md:p-12 flex flex-col items-center md:items-start border-t border-gray-800 min-h-[50vh] md:min-h-[40vh]">
      <div className="flex w-full flex-col md:flex-row items-center justify-between sm:justify-start md:pl-0 gap-4 md:gap-4 mb-6">
        <figure className="   h-[2rem] w-[2rem] sm:h-[3rem] sm:w-[3.7rem] grid place-items-center">
          <img
            src={logo}
            alt="Recidish Logo"
            className="h-[100%] w-[100%] sm:w-[100%] sm:h-[100%]"
          />
        </figure>
        <div className="flex gap-6 md:gap-8">
          <Link className="text-white text-base ">Our Communities</Link>
          <Link className="text-white text-base ">Help</Link>
        </div>
      </div>
      <div className="flex flex-col md:flex-row justify-between w-full items-center md:items-start gap-6 md:gap-8">
        <div className="flex flex-col md:w-[60%] text-center md:text-left gap-6">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-1 text-sm md:pr-[20%]">
            ...
            <Link className="text-white">Security</Link>
        ...
        <div className="flex flex-col items-center  gap-6 md:gap-2 md:items-center">
          <h3 className="text-white text-base md:text-lg sm:text-center">
            Contact Us
          </h3>
          <div className="flex gap-4 md:gap-2">
            <Link className="grid place-items-center w-10 h-10 md:w-12 md:h-12">
