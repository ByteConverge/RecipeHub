          ...
          >
            ...
            <div className="mb-2 sm:mb-1">
              ...
              <input
                ...
                onBlur={handleBlur}
                className="px-4 block w-full border-white font-poppins border-solid bg-black bg-opacity-50 focus:outline-none focus:border-white rounded-xl h-[2.5rem] sm:h-[1.7rem] sm:py-1 border-[0.772px]"
              />
            </div>
            {/* password */}
            <div className="mb-2 sm:mb-1">
              ...
              <input
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                className="px-4 block w-full border-white font-poppins border-[0.772px] border-solid bg-black bg-opacity-50 focus:outline-none focus:border-white rounded-xl h-[2.5rem] sm:h-[1.7rem] sm:py-1"
              />
            </div>
